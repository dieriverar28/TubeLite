...
class Config:
    ...
    # Opciones base (no incluye calidad ni volumen: esas se arman en
    # tiempo real en player.py segun las preferencias guardadas en
    # settings.py, para que un cambio en la pantalla de Configuracion
    # aplique sin tener que reiniciar TubeLite)
    MPV_OPTS = [
        "--ytdl=yes",
